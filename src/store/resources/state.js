const state = {
  ...
  cards: [
    ...
    {
      title: 'Video Introduction to Data Analysis with Jupyter Notebooks',
      body: `
        <a href="https://www.youtube.com/watch?v=Z-T76FQavig&list=PLzmqDzBWP43RxUN39mFip5nWsxlxEoV0J" target="_blank">These videos</a> use the <a href="https://github.com/digitaltxtlab/CLEAR" target="_blank">Computational Literary Repository (CLEAR)</a> to show learners first steps into data analysis with texts.
    ...
    {
      title: 'Video Course on Text Analysis with Voyant Tools',
      body: `
        This Video Course on <a href="https://voyant-tools.org/docs/#!/guide/start" target="_blank">Voyant Tools</a> starts out by describing how to install a local Voyant server for 
